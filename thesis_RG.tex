...
\usepackage[colorlinks=false,bookmarks=true,linktoc=all,bookmarkstype=toc,bookmarksopen=true]{hyperref}
...
% types of actors in information practices - der schnelle, der aufmüpfige etc?
...
%%% motivate more reflection on methods and tools
