...
\glsadd{LLTA_SW}
\newglossaryentry{LSJ}{type=software, name=Little Scott Jones, description={\url{}}}
\glsadd{LSJ}
%% P
...
In the present study, the participants abandoned the active seeking of information about software relatively early. Reasons for this are the lack of linguistic means to express their own information needs (see section \ref{sec:seeking_language_limits}). \citep{Savolainen2015a} has identified six different barriers in his conceptual analysis of cognitive barriers to information seeking. In addition to the four barriers of the final stage of the information seeking processes (unawareness of information sources, low self-efficacy, poor search skills, and inability to deal with information overload), there are also two barriers in the initial stage of information seeking that are of importance for this study. The speechlessness of classical philologists in describing their own information needs around software functionality is a cognitive barrier \citet[p. 616]{Savolainen2015a} refers to as "\textit{inability to articulate one's information needs}". \citet[p. 137]{Belkin1980} refers to it as "\textit{non-specifiability of information need}", whereby this can apply to both the cognitive and linguistic level.


Unwillingness to see one’s needs as information needs => fehlende reflektion research process; 

%% seeking kollegen/freunde => collaborative information seeking, social sharing => Talja2002
"Relying heavily on informal collaborative relationships, scholars manage their interdisciplinary information work by developing strategies for exploring and translating information from unfamiliar domains." \citep{Palmer2009}

%% proxy kollegen => awareness (talja2006), social sharing talja2002 Awareness isusually understood as knowledge and understanding of the activities of others, groups or individuals, which are important in providing a context for one’s own activity (Dourish & Bellotti, 1992). savolainen 2016, small world => making use of proxy information seekers in small-world communities
...
%%% Hypo 4 - Cognitive Barriers to information seeking
